    ...
    <section className="landing-hero">
      ...
      <div className="landing-hero-content">
        ...
        <div className="landing-hero-ctas">
          <a href="#community" className="landing-hero-cta-primary">{c.hero.ctaPrimary} ↓</a>
          <Link to="/volunteer" className="landing-hero-cta-secondary">{c.hero.ctaSecondary}</Link>
        </div>
        ...
        <div className="landing-quiz">
          <div className="landing-quiz-card">
            {done ? (
              ...
              <>
                <div className="landing-quiz-progress" aria-label={`Question ${qi + 1} of ${questions.length}`}>
                  {questions.map((_, i) => {
                ...
                <div className="landing-quiz-meta">
                  ...
                  <span className="landing-quiz-topic"
                    style={{ background: `${TOPIC_ACCENT[q.topic] ?? "var(--orange)"}20`, color: TOPIC_ACCENT[q.topic] ?? "var(--orange)" }}>
                    {q.topic}
                  </span>
                </div>
        ...
        <div className="landing-cta-grid">
          <article className="landing-cta-card">
            ...
            <div className="landing-cta-card-body">
              ...
              <Link to={c.cta.volunteer.route} className="landing-cta-btn landing-cta-btn-teal">
                {c.cta.volunteer.cta} →
              </Link>
            </div>
          </article>
          <article className="landing-cta-card">
            ...
            <div className="landing-cta-card-body">
              ...
              <Link to={c.cta.donate.route} className="landing-cta-btn landing-cta-btn-red">
                {c.cta.donate.cta} →
              </Link>
            </div>
          </article>
