...
function describeBackendEstimate(impact: ImpactPreview): string {
  ...
  return (
    <>
      <div className="donation-outcome-grid">
        <article><span>01</span><h4>Expected programme work</h4><p>{describeBackendEstimate(impact)} It is currently directed toward {programme.focus}.</p></article>
